...
Return the invlaid transactions where it will be one of the following, 
...
from
(select *, EXTRACT(day from time_stamp) as day_, EXTRACT(month from time_stamp) as mon,
EXTRACT(DOW from time_stamp) as dow, cast(time_stamp as time) as time_
