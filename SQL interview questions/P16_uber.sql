You’re given a table of Uber rides that contains the mileage and the purpose for the 
business expense. You’re asked to find business purposes that generate the most miles 
driven for passengers that use Uber for their business transportation. Find the top 3 
business purpose categories by total mileage.


CREATE TABLE my_uber_drives (start_date timestamp,end_date timestamp,category VARCHAR(50),start VARCHAR(50),stop VARCHAR(50),miles FLOAT,purpose VARCHAR(50));
...
select purpose, ROUND((SUM(miles))::numeric,2) tot_miles
from my_uber_drives
