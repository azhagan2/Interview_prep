...
-- Find the total number of transactions happened for each products
...
CREATE TABLE excel_sql_transaction_data (transaction_id INT PRIMARY KEY,time timestamp,product_id INT);
...
left join excel_sql_transaction_data b on a.product_id = b.product_id
