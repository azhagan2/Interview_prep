...
Find the difference between the highest salaries of two departments marketing and engineering
...
select MAX(CASE WHEN department = 'marketing' then salary end) - MAX(CASE WHEN department = 'engineering' then salary end) as salary_diff
from db_employee a 
